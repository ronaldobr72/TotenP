...
2. **Diálogo de Reposicionamento:** Ao término da Etapa 1, a máquina para e o Totem exibe uma tela modal com a instrução cadastrada (ex: *"Reposicionar peça no segundo batente..."*).
...
5. Clique no botão verde **`Salvar Composição`**.
6. A nova composição fica imediatamente disponível no cadastro de produtos com o selo `[Composto]`.
